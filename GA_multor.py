...
class ClifFred : 
  ...
  # Multiply multors: return  Z = X Y , grades from  lo  to  hi  inclusive 
  ...
  def zero (GA, X) : 
    # local k, t, err; global GA.eps, GA.len; 
    err = 0.0;  # error 
    for k in range(0, GA.dim+1) : 
      if X[k] <> [] : 
...
# Need multor class inheriting from ClifFred, link to parent via class vble  
